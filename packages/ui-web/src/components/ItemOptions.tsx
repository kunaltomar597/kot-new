...
/**
 * Variant and modifier choices for one item (MENU-003, MENU-004, MENU-012). The rules and prices
 * are `@rp/domain` menu-selection's (`validateSelection`, `unitPriceOf`), the same on every
 * surface and on the server (ORD-014).
 */
