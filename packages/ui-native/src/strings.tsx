 ...
 * announcements), with the same shape and `ui.*` catalogue keys as `@rp/ui-web`. Components never
 * hard-code UI text (NFR-L02): the app passes these from `@rp/i18n` through `UiStringsProvider`.
 */
